...
class ApiInvoker(formats: Formats)(implicit system: ActorSystem) extends CustomContentTypes with Json4sSupport {
  import it.pagopa.pdnd.interop.uservice.partymanagement.client.invoker.ApiInvoker._
  import it.pagopa.pdnd.interop.uservice.partymanagement.client.invoker.ParametersMap._
