...
kubectl create secret generic cassandra --from-literal=CASSANDRA_HOST=$CASSANDRA_HOST --from-literal=CASSANDRA_USER=$CASSANDRA_USR --from-literal=CASSANDRA_PWD=$CASSANDRA_PWD -n $NAMESPACE
