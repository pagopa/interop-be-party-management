...
package object impl extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val createdAtSeedFormat: RootJsonFormat[CreatedAtSeed]                   = jsonFormat1(CreatedAtSeed)
  ...
  implicit val relationshipSeedFormat: RootJsonFormat[RelationshipSeed]               = jsonFormat9(RelationshipSeed)
  ...
  implicit val newDesignTokenFormat: RootJsonFormat[NewDesignToken]         = jsonFormat14(NewDesignToken)
