...
import it.pagopa.pdnd.interop.uservice.partymanagement.model.persistence.{AttributesAdded, PartyAdded}
import it.pagopa.pdnd.interop.uservice.partymanagement.model.persistence.serializer.v1._

import java.io.NotSerializableException

class AttributesAddedSerializer extends SerializerWithStringManifest {
