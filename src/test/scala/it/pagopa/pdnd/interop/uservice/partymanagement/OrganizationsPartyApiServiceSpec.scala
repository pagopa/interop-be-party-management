...
object OrganizationsPartyApiServiceSpec {
  ...
  lazy final val seed1 = OrganizationSeed(institutionId1, "Institutions One", "John Doe", "mail1@mail.org")
  lazy final val seed2 = OrganizationSeed(institutionId2, "Institutions Two", "Tyler Durden", "mail2@mail.org")
  lazy final val seed3 = OrganizationSeed(institutionId3, "Institutions Three", "Kaiser Soze", "mail3@mail.org")
  lazy final val seed4 = OrganizationSeed(institutionId4, "Institutions Four", "Snake Plissken", "mail4@mail.org")
