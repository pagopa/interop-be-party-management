...
object TokenApiServiceData {
  ...
  lazy final val organizationSeed1 = OrganizationSeed(institutionId1, None, None, "Institutions Nine", "mail9@mail.org", "taxCode",    attributes = Seq.empty, products = Set.empty)
  lazy final val organizationSeed2 = OrganizationSeed(institutionId2, None, None, "Institutions Ten", "mail10@mail.org", "taxCode",    attributes = Seq.empty, products = Set.empty)
  lazy final val organizationSeed3 = OrganizationSeed(institutionId3, None, None, "Institutions Eleven", "mail11@mail.org", "taxCode", attributes = Seq.empty, products = Set.empty)
