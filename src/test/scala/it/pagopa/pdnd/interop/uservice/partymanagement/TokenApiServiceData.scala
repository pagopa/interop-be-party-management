...
object TokenApiServiceData {
  ...
  lazy final val partyRelationship1 = PartyRelationship(id = relationshipId1, start = OffsetDateTime.now(), end = None, status = Pending, from = UUID.fromString(createTokenUuid2), to = UUID.fromString(createTokenUuid3), role = Manager,  platformRole = "admin", filePath = None)
  lazy final val partyRelationship2 = PartyRelationship(id = relationshipId2, start = OffsetDateTime.now(), end = None, status = Pending, from = UUID.fromString(createTokenUuid2), to = UUID.fromString(createTokenUuid3), role = Delegate, platformRole = "admin", filePath = None)
  lazy final val partyRelationship3 = PartyRelationship(id = relationshipId3, start = OffsetDateTime.now(), end = None, status = Pending, from = UUID.fromString(createTokenUuid4), to = UUID.fromString(createTokenUuid5), role = Manager,  platformRole = "admin", filePath = None)
  lazy final val partyRelationship4 = PartyRelationship(id = relationshipId4, start = OffsetDateTime.now(), end = None, status = Pending, from = UUID.fromString(createTokenUuid4), to = UUID.fromString(createTokenUuid5), role = Delegate, platformRole = "admin", filePath = None)
