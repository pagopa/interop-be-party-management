...
object TokenApiServiceData {
  ...
  lazy final val organizationSeed1 = OrganizationSeed(institutionId1, "Institutions Nine", "mail9@mail.org", Seq.empty)
  lazy final val organizationSeed2 = OrganizationSeed(institutionId2, "Institutions Ten", "mail10@mail.org", Seq.empty)
  lazy final val organizationSeed3 = OrganizationSeed(institutionId3, "Institutions Eleven", "mail11@mail.org", Seq.empty)
